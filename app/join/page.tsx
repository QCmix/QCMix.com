                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-8 border-t border-b border-gray-200">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-500 text-sm">One role required</span>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-500 text-sm">Add context later</span>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-500 text-sm">Role changes reviewed</span>
                      </div>
                    </div>
                  </div>
                </section>
