    ...
    <main className="bg-[#08080f] min-h-screen">
      ...
      <section className="relative pt-32 pb-12 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/roles/Bartenders & Bar Staff.jpg"
            alt=""
            fill
        ...
        {/* Gradient orbs */}
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-violet-600/10 rounded-full blur-[120px] -translate-y-1/2" />
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-white/40 mb-8">
            ...
            <span className="text-white/60">Bartender</span>
          </div>

          {/* Header */}
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-500/20 to-purple-500/20 flex items-center justify-center text-violet-400">
            ...
            <div>
              ...
              <p className="text-white/50 mt-1">
                Guest-facing bar service and floor leadership
              </p>
            </div>
          </div>
        </div>
                ...
                {index < steps.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 mx-4 transition-all duration-300 ${
                      currentStep > step.id ? 'bg-violet-600' : 'bg-white/[0.06]'
                    }`}
                  />
                )}
              </div>
